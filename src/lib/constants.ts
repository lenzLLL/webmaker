...
export const pricingCards = [
  {
    ...
    features: ['3 Sub accounts', '2 Team members', 'Unlimited pipelines','chatbot'],
    priceId: '',
  },
  {
    ...
    priceId: 'price_1PlAs6JeHm2lLaL7wzXAhSuN',
  },
  {
    title: 'Basic',
    ...
    features: ['Unlimited Sub accounts', 'Unlimited Team members','Ai Editor','Call Video'],
    priceId: 'price_1PlAs6JeHm2lLaL75sg5OcLZ',
  },
]

export const addOnProducts = [
  { title: 'Priority Support', id: 'prod_QcQDOueu2igHLI' },
]
