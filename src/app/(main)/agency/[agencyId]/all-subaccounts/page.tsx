            ...
            <Command className="rounded-lg bg-transparent">
              ...
              {!!user.Agency?.SubAccount.length ? (
                user.Agency.SubAccount.map((subaccount: SubAccount) => (
                  <CommandItem
                    key={subaccount.id}
                    className="flex items-center py-10 h-32 !bg-background my-2 text-primary border-[1px] border-border p-4 rounded-lg hover:!bg-background cursor-pointer transition-all"
                  >
                    <Link
                    ...
                    >
                      <div className="relative">
                        <Image
                          ...
                          width={120}
                          height={120}
                          className="rounded-full object-cover bg-muted/50 p-4"
                        />
                      </div>
