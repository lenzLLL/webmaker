...
import CraeteContactButton from './_components/create-contact-bn'
...
const ContactPage = async ({ params }: Props) => {
  ...
  return (
    <BlurPage>
      <h1 className="text-4xl p-4 pl-0">Contacts</h1>
        ...
        <TableBody className="font-medium truncate">
          {allContacts.map((contact) => (
            <TableRow key={contact.id}>
              ...
              <TableCell><h1>{contact.createdAt.toString().split("(")[0]}</h1></TableCell>
