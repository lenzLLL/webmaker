...
import PipelineSettings from '../_components/pipline-setting'
import PipelineView from '../_components/pipeline-view'
type Props = {
    params:{subaccountId:string,pipelineId:string}
}
const PipelinesId = async ({params}:Props) => {
  
  const pipelineDetails = await getPipelineDetails(params.pipelineId)
  if(!pipelineDetails) redirect(`/subaccount/${params.subaccountId}/pipelines`)
