...
import { Calculator, Calendar, CheckIcon, ChevronsUpDownIcon, Smile, User2 } from 'lucide-react'
...
import TagCreator from '@/components/global/tag_creator'
      ...
      <CardContent>
        <Form {...form}>
          ...
          >
            ...
            <select className='outline-none p-4 bg-[#040007]' onChange={(e)=>setAssignedTo(e.target.value)}>
            <option key ="s" value ="null">Select team member</option>
