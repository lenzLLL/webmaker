      ...
      <div className="w-full p-24 flex flex-col  justify-center  h-full">
        ...
        >
          <Card
            ...
            className={cn(
              "flex flex-col items-center  mb-10 justify-center py-4 px-6 gap-4 cursor-pointer",
          ...
          <Card
            ...
            className={cn(
              "flex flex-col items-center  mb-10 justify-center p-4 gap-4 cursor-pointer",
